...
VALUES (0001, 'John', 'Doe', 001, 1, NULL), 
       (0002, 'Mike', 'Chan', 001, 2, 1), 
       (0003, 'Ashley', 'Rodriguez', 002, 3, 1), 
       (0004, 'Kevin', 'Tupik', 002, 4, 3), 
       (0005, 'Kunal', 'Singh', 003, 5, 3), 
       (0006, 'Malia', 'Brown', 003, 6, 1), 
       (0007, 'Sarah', 'Lourd', 004, 7, 6), 
       (0008, 'Tom', 'Allen', 004, 8, 6), 
       (0009, 'Troy', 'McDonald', 005, 9, 6), 
       (0010, 'Beth', 'Jenkins', 006, 10, 6);
